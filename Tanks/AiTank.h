...
public:
    ...
    AiTank(unsigned int health, unsigned int damage, float move_speed, uint32_t team_id, attack_type tank_attack_type)
        : Tank(health, damage, move_speed, team_id, tank_attack_type) {}
    ...
    void initialize(const sf::Vector2f& pos, const std::string& name) override;
