...
void AiTank::process_moving_to_base(sf::Vector2i ai_tank_tile, sf::Vector2i player_base_tile, int tank_i) {
...
void AiTank::process_chasing_enemy_tank(sf::Vector2i ai_tank_tile, sf::Vector2i player_tank_tile, int tank_i) {
